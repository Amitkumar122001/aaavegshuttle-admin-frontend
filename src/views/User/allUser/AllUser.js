...
const columns = [
  ...
  },
  {
    ...
    label: 'home_location_addressline1',
    minWidth: 200,
    align: 'center',
    format: (value) => value.toLocaleString('en-US')
  },
  {
    ...
    label: 'office_location_postal_code',
    minWidth: 200,
    align: 'center',
    format: (value) => value.toLocaleString('en-US')
  },
  ...
  },
  {
    ...
    label: 'office_location_addressline1',
    minWidth: 200,
    align: 'center',
    format: (value) => value.toLocaleString('en-US')
  },
                    ...
                    {displayItems()?.map((item, i) => {
                      return (
                        <TableRow key={i} hover>
                          ...
                          <TableCell align="center">{item.home_location_postal_code}</TableCell>
                          <TableCell align="center">{item.home_location_city}</TableCell>
                          <TableCell align="center">{item.home_location_state}</TableCell>
                          <TableCell align="center">{item.home_location_addressline1}</TableCell>
                          <TableCell align="center">{item.office_location_postal_code}</TableCell>
                          <TableCell align="center">{item.office_location_city}</TableCell>
                          <TableCell align="center">{item.office_location_state}</TableCell>
                          <TableCell align="center">{item.office_location_addressline1}</TableCell>
